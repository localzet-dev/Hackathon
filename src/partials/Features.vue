        ...
        <div>
          ...
          <div class="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
            ...
            <div class="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
              ...
              <h3 class="h3 bg-clip-text text-transparent bg-gradient-to-r from-neutral-200/60 via-neutral-200 to-neutral-200/60 pb-3">Simplify your security with authentication services</h3>
              <p class="text-lg text-neutral-400 mb-8">Define access roles for the end-users, and extend your authorization capabilities to implement dynamic access control.</p>
              <div class="mt-8 max-w-xs max-md:mx-auto space-y-2">
                <button class="flex items-center text-sm font-medium text-neutral-50 rounded border bg-neutral-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100" :class="tab !== '1' ? 'border-neutral-700 opacity-50' : 'border-purple-700 shadow shadow-purple-500/25'" @click.prevent="tab = '1'">
