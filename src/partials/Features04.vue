    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="pt-16 pb-12 md:pt-32 md:pb-20">
        ...
        <div class="max-w-3xl pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-neutral-200/60 via-neutral-200 to-neutral-200/60 pb-4">Why trust us?</h2>
          <p class="text-lg text-neutral-400">Many desktop publishing packages and web page editors now use lorem ipsum as their default model text, and a search will uncover many web sites still in their infancy.</p>
        </div>
          ...
          <div class="py-8 first-of-type:pt-0 last-of-type:pb-0">
            ...
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              ...
              <div>
                ...
                <p class="text-sm text-neutral-400">Login box must find the right balance for the user convenience, privacy and security.</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
