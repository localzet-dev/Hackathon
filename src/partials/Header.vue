        ...
        <nav class="flex grow">
          ...
          <ul class="flex grow justify-end flex-wrap items-center">
            ...
            <li class="ml-2 sm:ml-6">
              ...
              <a
                  class="sm:hidden mx-1 font-medium text-sm text-neutral-300 hover:text-white transition duration-150 ease-in-out"
