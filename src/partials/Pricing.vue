    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-neutral-200/60 via-neutral-200 to-neutral-200/60 pb-4">Flexible plans and features</h2>
              ...
              <div class="pb-5 md:border-b border-neutral-800">
                ...
                <div class="max-md:text-center">
                  <div class="inline-flex items-center whitespace-nowrap">
                    ...
                    <div class="text-sm text-neutral-500 font-medium ml-2">Yearly <span class="text-teal-500">(-20%)</span></div>
                  </div>
                </div>
              </div>
            </div>
